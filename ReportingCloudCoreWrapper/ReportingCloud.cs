/*-------------------------------------------------------------------------------------------------------------
 * module:			ReportingCloud .NET Core Wrapper (sync version)
 *
...
namespace TXTextControl.ReportingCloud
{
    /*-------------------------------------------------------------------------------------------------------
    // ** ReportingCloud **
    // This class contains the implementation of the ReportingCloud wrapper for Core .NET
    *-----------------------------------------------------------------------------------------------------*/
        ...
        *-----------------------------------------------------------------------------------------------------*/
        ...
        public List<APIKey> GetAccountAPIKeys()
        {
            ...
            using (HttpClient client = CreateHttpClient())
            {
                ...
                {
                    return (List<APIKey>)JsonConvert.DeserializeObject(response.Content.ReadAsStringAsync().Result, typeof(List<APIKey>));
                }
                else
                {
        ...
        public void UploadTemplate(string templateName, byte[] template)
        {
            ...
            using (HttpClient client = CreateHttpClient())
            {
                ...
                HttpResponseMessage response = client.PostAsync("v1/templates/upload?templateName=" + templateName, 
                    new StringContent(JsonConvert.SerializeObject(template), Encoding.UTF8, "application/json")).Result;
        ...
        *-----------------------------------------------------------------------------------------------------*/
        ...
        public TemplateInfo GetTemplateInfo(string templateName)
        {
            ...
            using (HttpClient client = CreateHttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    return (TemplateInfo)JsonConvert.DeserializeObject(response.Content.ReadAsStringAsync().Result, typeof(TemplateInfo));
                }
                else
                {
                    // throw exception with the message from the endpoint
        ...
        *-----------------------------------------------------------------------------------------------------*/
        ...
        public List<IncorrectWord> CheckText(string text, string language)
        {
            ...
            using (HttpClient client = CreateHttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    return (List<IncorrectWord>)JsonConvert.DeserializeObject(response.Content.ReadAsStringAsync().Result, typeof(List<IncorrectWord>));
                }
                else
                {
                    // throw exception with the message from the endpoint
        ...
        *-----------------------------------------------------------------------------------------------------*/
        ...
        public AccountSettings GetAccountSettings()
        {
            ...
            using (HttpClient client = CreateHttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    return (AccountSettings)JsonConvert.DeserializeObject(response.Content.ReadAsStringAsync().Result, typeof(AccountSettings));
                }
                else
                {
                    // throw exception with the message from the endpoint
        ...
        *-----------------------------------------------------------------------------------------------------*/
        ...
        public int GetTemplateCount()
        {
            ...
            using (HttpClient client = CreateHttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    return (int)JsonConvert.DeserializeObject(response.Content.ReadAsStringAsync().Result, typeof(int));
                }
                else
                {
                    // throw exception with the message from the endpoint
        ...
        *-----------------------------------------------------------------------------------------------------*/
        ...
        public bool TemplateExists(string templateName)
        {
            ...
            using (HttpClient client = CreateHttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    return (bool)JsonConvert.DeserializeObject(response.Content.ReadAsStringAsync().Result, typeof(bool));
                }
                else
                {
                    // throw exception with the message from the endpoint
        ...
        *-----------------------------------------------------------------------------------------------------*/
        ...
        public List<Template> ListTemplates()
        {
            ...
            using (HttpClient client = CreateHttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    return (List<Template>)JsonConvert.DeserializeObject(response.Content.ReadAsStringAsync().Result, typeof(List<Template>));
                }
                else
                {
                    // throw exception with the message from the endpoint
